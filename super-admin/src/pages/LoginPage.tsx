  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface-app px-4">
      <div className="w-full max-w-sm">
        ...
        >
          <h1 className="mb-1 text-lg font-semibold text-zinc-100">Super Admin Sign In</h1>
          <p className="mb-6 text-sm text-zinc-500">Platform control center — invite only.</p>
